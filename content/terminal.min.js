    ...
    var Terminal =
        ...
        function (containerID, options) {
            ...
            var defaults = {
                welcome: "",
                prompt:
                    '<span class="user">guest</span><span class="separator">@</span><span class="hostname">smep</span><span class="separator2">:</span>',
            ...
            _terminal.insertAdjacentHTML(
                ...
                [
                    ...
                    "<br />███████╗███╗&nbsp;&nbsp;&nbsp;███╗███████╗██████╗<br/>██╔════╝████╗&nbsp;████║██╔════╝██╔══██╗<br/>███████╗██╔████╔██║█████╗  &nbsp;██████╔╝<br/>╚════██║██║╚██╔╝██║██╔══╝&nbsp;  ██╔═══╝<br/>███████║██║ ╚═╝ ██║███████╗██║<br/>╚══════╝╚═╝&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╚═╝╚══════╝╚═╝  ",
                    "</div>",
                    "<br /> Back to home page: <a href='https://guillaumedupuy.github.io/Site-CTF/'>Home</a>",
                    "<br />",
                    ,
                ...
                content: [
                    {
                        ...
                        content: [
                            {
                                name: "Sur_un_malentendu_ca_passe",
                                type: fileType.LINK,
                                content: "https://guillaumedupuy.github.io/Site-CTF/",
                            },
                        ],
                    },
                    {
                        ...
                        content: [
                            {
                                name: "Writeups",
                                type: fileType.LINK,
                                content: "https://github.com/GuillaumeDupuy/CTF",
                            },
                            {
                                name: "participation_list_CTFs",
                                type: fileType.LINK,
                                content: "https://guillaumedupuy.github.io/Site-CTF/ctfs/",
                            },
                        ],
                    },
                    {
                        ...
                        content: [
                            ...
                            },                            
                            {
                                name: "Tot0p",
                                type: fileType.LINK,
                                content: "https://www.linkedin.com/in/thomas-lemaitre78/",
                            },
                            {
                                name: "Mkarten",
                                type: fileType.LINK,
                                content: "https://www.linkedin.com/in/lucamorgado/",
                            },
                            {
                                name: "Feitan",
                                type: fileType.LINK,
                                content: "https://www.linkedin.com/in/charles-fisman/",
                            },
                            {
                                name: "personnal_site",
                                type: fileType.DIRECTORY,
                        ...
                        content: [
                            {
                                name: "ctftime",
                                type: fileType.LINK,
                                content: "https://ctftime.org/team/215454",
                            },
                            {
                                name: "github",
                                type: fileType.LINK,
                                content: "https://github.com/Sur-un-malentendu-ca-passe",
                            },
                            {
                                name: "linkedIn",
                                type: fileType.LINK,
                                content: "https://www.linkedin.com/company/93776217/admin/",
                            },
                        ],
                    },
                    {
                        ...
                        content: `Hi,
                        		...
                        		Oh, by the way, can you find the string behind U01FUHszbmMwZDNkX2ZsYTl9== ?
            ...
            var availableCommands = {
                ...
                open: {
                    ...
                    usage: "open /site/Sur_un_malentendu_ca_passe",
                },
                pwd: {
                    req_args: [],
                    opt_args: [],
...
function generateRandomCharacter() {
    ...
    if (randomNumber < 0.5) {
      ...
      const randomChineseCharacter = String.fromCharCode(Math.floor(Math.random() * (40959 - 19968 + 1)) + 19968);
